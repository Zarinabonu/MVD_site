# Generated by Django 2.2.5 on 2019-09-13 13:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_content_uz', models.TextField(blank=True, null=True)),
                ('full_content_ru', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title_name_ru', models.CharField(blank=True, max_length=100, null=True)),
                ('title_name_uz', models.CharField(blank=True, max_length=100, null=True)),
                ('full_content_uz', models.TextField(blank=True, null=True)),
                ('full_content_ru', models.TextField(blank=True, null=True)),
                ('short_content_uz', models.TextField(blank=True, null=True)),
                ('short_content_ru', models.TextField(blank=True, null=True)),
